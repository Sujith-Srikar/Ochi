...
function Footer() {
  ...
  return (
    <>
      <div className="flex gap-5 w-full h-screen bg-zinc-900 p-20 font-['Founders_Grotesk_XCondensed_Bold']">
          ...
          <div className="dets font-['Neue_Montreal'] mt-10">
            {[
              ...
              return (
                <a
                  key={index}
                  className={"block text-xl font-light border-b-[2px] border-white w-[100px]"}
                  href="#"
                >
                  {item}
                </a>
